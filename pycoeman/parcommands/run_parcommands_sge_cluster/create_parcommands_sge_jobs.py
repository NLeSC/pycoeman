...
def argument_parser():
   # define argument menu
    description = "Creates the jobs to submit to a SGE cluster for the commands specified in the XML configuration file. During the execution of each command there is monitoring of the used CPU/MEM/disk by the system."
